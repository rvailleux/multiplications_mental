...
### Tests for User Story 1 (Unit/Integration - OPTIONAL, E2E - MANDATORY) ⚠️

> **NOTE: Write these tests FIRST, ensure they FAIL before implementation**

**Unit/Integration Tests (OPTIONAL - only if requested)**:
- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py

**E2E Tests (MANDATORY - Constitutional Requirement Principle VIII)**:
- [ ] T012 [US1] **E2E test for primary user journey** in tests/e2e/user-story-1.spec.ts
  ...
  - Validate final state matches acceptance criteria
...
- [ ] T019 [US1] **Verify E2E test passes** - Run `npx playwright test tests/e2e/user-story-1.spec.ts`
- [ ] T020 [US1] **Review E2E screenshots** - Validate visual state at each step
- [ ] T021 [US1] **Manual E2E verification** - Test keyboard + mouse paths in real browser
...
### Tests for User Story 2 (Unit/Integration - OPTIONAL, E2E - MANDATORY) ⚠️
...
**E2E Tests (MANDATORY - Constitutional Requirement Principle VIII)**:
- [ ] T024 [US2] **E2E test for primary user journey** in tests/e2e/user-story-2.spec.ts
...
- [ ] T029 [US2] **Verify E2E test passes** - Run `npx playwright test tests/e2e/user-story-2.spec.ts`
- [ ] T030 [US2] **Review E2E screenshots** - Validate visual consistency
- [ ] T031 [US2] **Manual E2E verification** - Test both input methods
...
### Tests for User Story 3 (Unit/Integration - OPTIONAL, E2E - MANDATORY) ⚠️
...
**E2E Tests (MANDATORY - Constitutional Requirement Principle VIII)**:
- [ ] T034 [US3] **E2E test for primary user journey** in tests/e2e/user-story-3.spec.ts
  - Map to E2E-US3-001 from spec.md
  - Test keyboard + mouse paths
...
- [ ] T038 [US3] **Verify E2E test passes** - Run Playwright tests
- [ ] T039 [US3] **Review E2E screenshots** - Check visual regressions
- [ ] T040 [US3] **Manual E2E verification** - Full user journey test
...
- [ ] TXXX **E2E regression suite** - Run all E2E tests (`npx playwright test`)
- [ ] TXXX **E2E visual review** - Check all screenshots for consistency
